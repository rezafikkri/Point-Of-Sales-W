...
tableElement.querySelector('tbody').addEventListener('click', async (e) => {
  ...
  if (targetElement.getAttribute('id') != 'show-details') targetElement = targetElement.parentElement;
  if (targetElement.getAttribute('id') != 'show-details') targetElement = targetElement.parentElement;
  if (targetElement.getAttribute('id') == 'show-details') {
    e.preventDefault();
    ...
    if (responseJson.products.length > 0) {
      ...
      responseJson.products.forEach((p, i) => {
        ...
        tr += `
          ...
          <td width="10"><a href="#" id="show-details" data-product-id="${p.product_id}" title="Lihat detail produk"><svg xmlns="http://www.w3.org/2000/svg" width="21" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/></svg></a></td>
...
// delete products and automatic delete product prices

    ...
    <div class="row mb-3">
        ...
        <div class="info-box info-box--blue">
            <div class="info-box__data">
                ...
                <p class="mb-0" title="Transaksi terakhir">5 Jan 2021</p>
            </div>
        ...
        <div class="info-box info-box--sky-blue">
            <div class="info-box__data">
                ...
                <p class="mb-0" title="Pengguna terakhir ditambahkan">3 Jan 2020</p>
            </div>
            <div class="info-box__icon">
        ...
        <div class="info-box info-box--green">
            <div class="info-box__data">
                ...
                <p class="mb-0" title="Produk terakhir ditambahkan">1 Jan 2021</p>
            </div>
            <div class="info-box__icon">

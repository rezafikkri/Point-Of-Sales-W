        ...
        <div class="main__box">
            <?= form_open('/admin/user/update') ?>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-input" id="full-name" type="text" name="full_name" value="<?= $user['full_name'] ?? null ?>">
                ...
                <div class="mb-4">
                    ...
                    <?= $_SESSION['errors']['password'] ?? '<small class="form-message form-message--info">
                    Isi password jika ingin mengubah password.</small>' ?>
                </div>
                <div class="mb-4">
